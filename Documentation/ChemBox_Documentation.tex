...
\cline{3-5}
& & E: Fill in all 3 input options with common values & Pop up dialogue states invalid input. & -\\
\cline{3-5}
& & X: Use invalid characters & Pop up dialogue states invalid input. & - \\

\hline

\multirow{3}{*}{2} & Test unit drop down  & T: Change units & Calculated value scales accordingly. & As expected.\\

\hline
\end{tabularx}
\caption{Universal Calculator tests}
\label{calculator_tests}
\end{table}
