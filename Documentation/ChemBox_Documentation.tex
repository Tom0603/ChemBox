...
Although this code is very overly complicated, it worked most of the times for basic or intermediate level equations.\\
...
\begin{figure} [h]
	\centering
	\includegraphics[scale=0.5]{nullspace_error}
